        ...
        <div class="uk-child-width-1-1 uk-child-width-1-2@m uk-margin uk-flex uk-flex-center" uk-grid>
            ...
            <div class="uk-margin-medium-bottom">
                ...
                <div class="uk-card uk-card-body uk-card-default uk-width-1-1 uk-border-rounded">
                    ...
                    flash('success-data-inscription');
                    flash('error-data-connexion');

                    $form = tr_form('inscrit', 'connectOne');
                    $form->useUrl('post', '/connect/one');
                    ...
                    <div class="uk-form-stacked">
                        <div class="uk-margin">
                            <label class="uk-form-label uk-text-bold uk-text-center" for="tr_field_pseudo">Votre pseudo ou votre numero whatsapp</label>
                            <div class="uk-form-controls">
                                <?= $form->text('pseudo')->setAttributes(['class' => 'uk-input', 'placeholder' => 'pseudo ou numero whatsapp']) ?>
                            </div>
                        </div>
                        <div class="uk-margin">
                            <div class="uk-form-controls uk-text-center">
                                <button class="uk-button uk-button-primary uk-width-1-1" type="submit" id="submit">Continuer</button>
                            </div>
                        </div>
                    </div>
