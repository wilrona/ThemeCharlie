...
<div class="uk-section uk-section-small uk-background-muted">
    <div class="uk-container uk-container-small">
        <h1 class="uk-text-center uk-margin-remove">Connexion en tant que escort</h1>
    </div>
</div>

<div class="uk-section typerocket-container">
    <div class="uk-container uk-container-small uk-position-relative">
        <div class="uk-child-width-1-1 uk-child-width-1-2@m uk-margin uk-flex uk-flex-center" uk-grid>

            <div class="uk-margin-medium-bottom">
                
                <h4 class="uk-text-center">Insérez le mot de passe que vous avez reçu sur votre numéro whatsapp pour terminer votre identification</h4>

                <div class="uk-card uk-card-body uk-card-default uk-width-1-1 uk-border-rounded">
                    <h3 class="uk-text-danger-c uk-text-center uk-text-bold ">Connexion</h3>
                    <?php
                    
                    flash('infos-data-connexion');
                    flash('error-data-connexion');

                    $form = tr_form('inscrit', 'connectTwo');
                    $form->useUrl('post', '/connect/two');
                    ...
                    <div class="uk-form-stacked">
                        <div class="uk-margin">
                            <label class="uk-form-label uk-text-bold uk-text-center" for="tr_field_pseudo">Mot de passe</label>
                            <div class="uk-form-controls">
                                <?= $form->password('password')->setAttributes(['class' => 'uk-input', 'placeholder' => 'mot de passe']) ?>
                            </div>
                        </div>
                        <div class="uk-margin">
                            <div class="uk-form-controls uk-text-center">
                                <button class="uk-button uk-button-primary uk-width-1-1" type="submit" id="submit">Valider</button>
                            </div>
                        </div>
                    </div>
