...
<div class="uk-section uk-section-small uk-background-muted">
    <div class="uk-container uk-container-small">
        ...
        <h4 class="uk-text-center uk-margin-remove uk-text-bold">Etape 1/4</h4>
    </div>
</div>

<div class="uk-section typerocket-container">
    <div class="uk-container uk-container-small uk-flex uk-flex-center">
        <div class="uk-card uk-card-body uk-card-default uk-width-1-2@m uk-width-1-1 uk-border-rounded">
            ...
            <div class="uk-form-stacked">
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <?= $form->text('pseudo')->setAttributes(['class' => 'uk-input uk-border-rounded']) ?>
                    </div>
                </div>
                <div class="uk-margin">
                    <label class="uk-form-label uk-text-bold" for="tr_field_name">Nom complet</label>
                    <div class="uk-form-controls">
                        <?= $form->text('name')->setAttributes(['class' => 'uk-input uk-border-rounded']) ?>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <?= $form->text('datenais')->setAttributes(['class' => 'uk-input uk-border-rounded', 'id' => 'datepickerbirth']) ?>
