...
<div class="uk-section uk-section-small uk-background-muted">
    <div class="uk-container uk-container-small">
        ...
        <h4 class="uk-text-center uk-margin-remove uk-text-bold">Etape 4/4</h4>
    </div>
</div>
...
<div class="uk-section typerocket-container">
    <div class="uk-container uk-container-small uk-flex uk-flex-center">
        <div class="uk-card uk-card-body uk-card-default uk-width-5-6@m uk-width-1-1 uk-border-rounded">
            ...
            $form = tr_form('inscrit', 'inscrireFour');
            $form->useUrl('post', '/inscrire/four');
            ...
            <div class="uk-form-stacked">
                ...
                <?php
                    ...
                    if(isset($_SESSION['inscription']['four']['existCode'])):
                        $showActivation = false;
                    endif;
                        ...
                        <div class="uk-text-small">
                            ...
                            <div class="uk-flex uk-flex-center">
                                <ul class="uk-list uk-list-bullet">
                                    <li>Recevoir les notifications des nouvelles reservations</li>
                                    <li>Interagir avec la plateforme pour indiquer votre disponibilité</li>
                                    <li>Etre transmis aux client qui vont vous solliciter sur notre plateforme</li>
                                    <li>Facilier la mise en relation direct avec vos clients</li>
                                </ul>
                            </div>
                            ...
                            <div class="uk-flex uk-flex-center uk-margin-top uk-margin-bottom">
                                <div class="uk-padding-small uk-background-muted uk-width-1-2@l uk-h3 uk-text-center">
                                    Envoie ce code  <span class="uk-text-danger-c"><?= $_SESSION['inscription']['four']['codeconfirmation'] ?></span>

                                    <a href="<?= home_url('/inscription/four/') ?>?generate=1" class="uk-margin-top uk-display-block uk-text-small-c uk-link-muted">Génére un nouveau code</a>
                                </div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <?= $form->hidden('codeconfirmation')->setDefault($_SESSION['inscription']['four']['codeconfirmation']); ?>
