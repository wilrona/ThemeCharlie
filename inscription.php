...
<?php
    ...
    if(isset($_SESSION['inscription']) && !isset($_SESSION['inscription']['four']['existCode'])):
...
<div class="uk-section typerocket-container">
    <div class="uk-container uk-container-small uk-position-relative">
        <div class="uk-child-width-1-1 uk-child-width-1-2@m uk-margin" uk-grid>
            ...
            <div>
                <div class="">
                    <h3 class="uk-text-danger-c uk-text-center uk-text-bold uk-margin-medium-bottom"><?= tr_posts_field('infos_insc') ?></h3>
                    <?php
                        foreach (tr_posts_field('list_infos_insc') as $gauche):
                    ?>
                        <div uk-grid class="uk-background-default uk-card-body uk-border-rounded uk-grid-collapse uk-margin uk-card uk-card-default uk-card-small">
            ...
            <div class="uk-flex uk-flex-middle uk-flex-center">
                <div class="uk-card uk-card-body uk-card-default uk-width-1-1 uk-border-rounded">
                    <h3 class="uk-text-danger-c uk-text-center uk-text-bold ">Inscrit-toi maintenant</h3>
                    <?php

                        flash('error-data-inscription');

                        $form = tr_form('inscrit', 'inscrireOne');
                        $form->useUrl('post', '/inscrire/one');
                    ...
                    <div class="uk-form-stacked">
                        ...
                        <div class="uk-margin">
                            ...
                            <div class="uk-form-controls">
                                ...
                                ?>
                                <?= $form->select('sexe')->setOptions($value)->setAttribute('class', 'uk-select'); ?>
                            </div>
                        </div>
                        <div class="uk-margin">
